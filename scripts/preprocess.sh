...
module_defaults() {
	...
	DEFAULT_MODULE_BASE_REPO=$(jq ".DEFAULT_MODULE_BASE_REPO" $CONFIG_FILE)
	DEFAULT_MODULE_BUILD_CMD=$(jq ".DEFAULT_MODULE_BUILD_CMD" $CONFIG_FILE)
	UPDATE_INSTALLED_MODULE_STATUS_QUERY=$(jq ".UPDATE_INSTALLED_MODULE_STATUS_QUERY" $CONFIG_FILE)
	DELETE_INSTALLED_MODULE_QUERY=$(jq ".DELETE_INSTALLED_MODULE_QUERY" $CONFIG_FILE)
	ENABLE_FREE_ALLOCATED_PORTS_FOR_OKAPI_MODULES=$(jq ".ENABLE_FREE_ALLOCATED_PORTS_FOR_OKAPI_MODULES" $CONFIG_FILE)
	...
	export DEFAULT_MODULE_BASE_REPO=$(echo $DEFAULT_MODULE_BASE_REPO | sed 's/"//g')
	export DEFAULT_MODULE_BUILD_CMD=$(echo $DEFAULT_MODULE_BUILD_CMD | sed 's/"//g')
	export UPDATE_INSTALLED_MODULE_STATUS_QUERY=$(echo $UPDATE_INSTALLED_MODULE_STATUS_QUERY | sed 's/"//g')
	export DELETE_INSTALLED_MODULE_QUERY=$(echo $DELETE_INSTALLED_MODULE_QUERY | sed 's/"//g')
	export ENABLE_FREE_ALLOCATED_PORTS_FOR_OKAPI_MODULES=$(echo $ENABLE_FREE_ALLOCATED_PORTS_FOR_OKAPI_MODULES | sed 's/"//g')
